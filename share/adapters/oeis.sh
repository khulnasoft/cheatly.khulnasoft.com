...
curl cheatly.khulnasoft.com/oeis/1+1+1+1

# Describe an OEIS sequence (A2)
curl cheatly.khulnasoft.com/oeis/A2

# Implementation of the A2 OEIS sequence in Python
curl cheatly.khulnasoft.com/oeis/A2/python

# List all available implementations of the A2 OEIS sequence
curl cheatly.khulnasoft.com/oeis/A2/:list
"
    rm -rf $TMP
    return 1
  fi
