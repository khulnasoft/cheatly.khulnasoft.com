...
def _config_locations():
    ...
    * `_WORKDIR`, `_CONF_FILE_WORKDIR`, `_CONF_FILE_MYDIR`
    ...
    workdir = os.environ[var] if var in os.environ \
        else os.path.join(os.environ['HOME'], '.cheatly.khulnasoft.com')
...
_CONFIG = {
    "adapters.active": [
        ...
        "late.nz",
        "question",
        "cheatly.khulnasoft.comeets",
        "cheatly.khulnasoft.comeets dir",
        "learnxiny",
        "rfc",
        "oeis",
        "chmod",
    ...
    "upstream.url": "https://cheatly.khulnasoft.com",
    "upstream.timeout": 5,
    "search.limit": 20,
    "server.bind": "0.0.0.0",
    "server.port": 8002,
