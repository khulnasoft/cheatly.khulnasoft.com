...
GITHUB_REPOSITORY = {
    ...
    "cheatly"      :   'khulnasoft/cheatly',
    "cheatly dir"  :   'khulnasoft/cheatly',
...
def visualize(answer_data, request_options):
    ...
    editable = (len(answers) == 1 and answers[0]['topic_type'] == 'cheatly')
...
def _render_html(query, result, editable, repository_button, topics_list, request_options):
    ...
    if editable:
        ...
        if '/' in query:
            query = '_' + query
        edit_page_link = 'https://github.com/khulnasoft/cheatly/tree/master/cheatsheets/edit/master/sheets/' + query
        edit_button = (
