...
cheatly.  The cheat sheets repository is hierarchically structured: cheat
...
class CheatSheets(GitRepositoryAdapter):
    ...
    """
    Adapter for the cheatly cheat sheets.
    """

    _adapter_name = "cheatly"
    _output_format = "code"
    _repository_url = "https://github.com/khulnasoft/cheatly/tree/master/cheatsheets"
